...
export type HttpsLottiefilesGithubIoLottieDocsSchemaLottieSchemaJson = Animation;
/**
...
export type MatteTarget = number;
/**
...
export type Mode1 = No | Add | Subtract | Intersect | Lighten | Darken | Difference;
export type No = "n";
export type Add = "a";
...
export type PaintOverTransparentEffect = Effect & {
  ty: Type27;
  ef?: EffectValues13;
  [k: string]: unknown;
};
export type Type27 = 7;
...
export type Composite2 = Above | Below;
export type Above = 1;
export type Below = 2;
/**
...
export type Multiple2 = Individually | Simultaneously;
export type Individually = 1;
export type Simultaneously = 2;
...
export type MergeMode2 = Normal3 | Add2 | Subtract1 | Intersect1 | ExcludeIntersections;
 ...
 * @maxItems 4
 */
export type FillColor1 = [number, number, number] | [number, number, number, number];
/**
 * Color as a [r, g, b] array with values in [0, 1]
 *
 * @minItems 3
 * @maxItems 4
 */
export type StrokeColor1 = [number, number, number] | [number, number, number, number];
